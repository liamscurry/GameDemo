...
public sealed class PlayerFireballTier2 : PlayerAbility
{
    ...
    public override void Initialize(PlayerAbilityManager abilitySystem)
    {
        ...
        GenerateCoolDownIcon(
            staminaCost,
            Resources.Load<Sprite>(ResourceConstants.Player.UI.Abilities.FireballTier2Icon),
            "II");
    }
