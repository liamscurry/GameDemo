...
public sealed class PlayerFireChargeTier3 : PlayerAbility 
{
    ...
    public override void Initialize(PlayerAbilityManager abilityManager)
    {
        ...
        GenerateCoolDownIcon(
            staminaCost,
            Resources.Load<Sprite>(ResourceConstants.Player.Abilities.FirechargeTier3Icon),
            "III");
    }
    ...
    private void ActBegin()
    {
        ...
        for (int i = 0; i < 7; i++)
        {
            ...
            hitboxes[i].Invoke(this, PlayerMultiDamageHitbox.ObstructionType.LocalOrigin);           
