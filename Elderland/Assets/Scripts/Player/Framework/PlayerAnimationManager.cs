...
public class PlayerAnimationManager 
{
	...
	/*
	Updates free directional movement walk properties in animator.
	Inputs:
	None
	...
	None
	*/
	public void UpdateFreeWalkProperties()
    {
		if (!movedThisFrame)
		{
			movedThisFrame = true;
	...
	None
	*/
	public void UpdateFreeRotationProperties()
    {
	...
	*/
	...
	/*
	Updates octagonal directional movement walk properties in animator. Player faces away from camera
	always when moving.
	Inputs:
	None
	...
	None
	*/
    public void UpdateOctagonalWalkProperties()
    {
		if (!movedThisFrame)
		{
			movedThisFrame = true;
	...
	/*
	Updates animator property "rotationSpeed " responsible for turning the player when standing still
	during octagonal movement.
	...
	None
	*/
	public void UpdateOctagonalRotationProperties()
    {
